...
class Ui_RGBT(object):
    def setupUi(self, RGBT):
        ...
        self.gridLayout_3.addWidget(self.text_pid, 2, 1, 1, 1)
        ...
        self.comboBox_2.setStyleSheet(u"text-align:left")
        ...
        self.gridLayout_3.addWidget(self.label_pid, 2, 0, 1, 1)
        ...
        self.recordButton.setStyleSheet(u"text-align:left")
        ...
        self.acquireButton.setStyleSheet(u"text-align:left")
        ...
        self.comboBox.setStyleSheet(u"text-align:left")
        ...
        self.comboBox_3.setStyleSheet(u"text-align:left")
        ...
        self.horizontalSlider_focus.setSliderPosition(25)
        self.horizontalSlider_focus.setOrientation(Qt.Horizontal)

        self.gridLayout_3.addWidget(self.horizontalSlider_focus, 3, 6, 1, 2)
    ...
    def retranslateUi(self, RGBT):
        ...
        self.comboBox_2.setItemText(0, QCoreApplication.translate("RGBT", u"CoolWarm", None))
        self.comboBox_2.setItemText(1, QCoreApplication.translate("RGBT", u"GNUPlot2", None))
        self.comboBox_2.setItemText(2, QCoreApplication.translate("RGBT", u"Gray", None))
        self.comboBox_2.setItemText(3, QCoreApplication.translate("RGBT", u"Magma", None))
        self.comboBox_2.setItemText(4, QCoreApplication.translate("RGBT", u"Nipy_Spectral", None))
        self.comboBox_2.setItemText(5, QCoreApplication.translate("RGBT", u"Pink", None))
        self.comboBox_2.setItemText(6, QCoreApplication.translate("RGBT", u"Plasma", None))
        self.comboBox_2.setItemText(7, QCoreApplication.translate("RGBT", u"Prism", None))
        self.comboBox_2.setItemText(8, QCoreApplication.translate("RGBT", u"Rainbow", None))
        self.comboBox_2.setItemText(9, QCoreApplication.translate("RGBT", u"Seismic", None))
        self.comboBox_2.setItemText(10, QCoreApplication.translate("RGBT", u"Terrain", None))
        ...
        self.comboBox_RGB_Cam.setItemText(0, QCoreApplication.translate("RGBT", u"Select RGB Camera", None))
        ...
        self.comboBox.setItemText(0, QCoreApplication.translate("RGBT", u"Auto", None))
        self.comboBox.setItemText(1, QCoreApplication.translate("RGBT", u"Manual", None))
